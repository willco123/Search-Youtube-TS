...
exports.getChildItemsWithFK =
  exports.getParentItemByFK =
  exports.searchVideosFromDB =
  exports.searchChannelsFromDB =
  exports.searchDBFromTable =
  exports.deleteItemByIDFromTable =
  exports.getItemByIDFromTable =
  exports.getAllFromTable =
  exports.checkUniqueness =
  exports.insertIntoVideos =
  exports.insertIntoChannelsReturnID =
    void 0;
...
function insertIntoChannelsReturnID(channelName) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      let [query] = yield db_1.default.query(
...
function deleteItemByIDFromTable(table, id) {
  return __awaiter(this, void 0, void 0, function* () {
    const [deletedItem] = yield db_1.default.query(
...
function searchVideosFromDB(column, value) {
  return __awaiter(this, void 0, void 0, function* () {
    const query = yield db_1.default.query(
      "SELECT * FROM videos WHERE (??) RLIKE (?)",
      [column, value],
    );
    const results = (0, type_guard_helpers_1.arrayTypeGuard)(query);
    return results;
